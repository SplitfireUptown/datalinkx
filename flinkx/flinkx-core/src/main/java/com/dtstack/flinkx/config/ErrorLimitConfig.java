...
public class ErrorLimitConfig extends AbstractConfig {
    ...
    public static final String KEY_ERROR_TRY_PLAN = "tryPlan";

    public static final int DEFAULT_ERROR_RECORD_LIMIT = 0;
    public static final double DEFAULT_ERROR_PERCENTAGE_LIMIT = 0.0;
    // onebyone: 逐条重试, binary: 二分法重试, none: 不退化重试，批量异常后直接失败
    public static final String ERROR_TRY_PLAN_ONE_BY_ONE = "onebyone";
    public static final String ERROR_TRY_PLAN_BINARY = "binary";
    public static final String ERROR_TRY_PLAN_NONE = "none";
    ...
    public static ErrorLimitConfig defaultConfig(){
        ...
        map.put(KEY_ERROR_TRY_PLAN, ERROR_TRY_PLAN_ONE_BY_ONE);
    ...
    public String getTryPlan() {
        return getStringVal(KEY_ERROR_TRY_PLAN, ERROR_TRY_PLAN_ONE_BY_ONE);
    }
}