...
import static com.dtstack.flinkx.kafkabase.KafkaConfigKeys.KEY_COMPRESS;
import static com.dtstack.flinkx.kafkabase.KafkaConfigKeys.KEY_PRODUCER_SETTINGS;
import static com.dtstack.flinkx.kafkabase.KafkaConfigKeys.KEY_SEPARATOR;
import static com.dtstack.flinkx.kafkabase.KafkaConfigKeys.KEY_COMPRESS;
...
public class KafkaBaseWriter extends BaseDataWriter {
    ...
    public KafkaBaseWriter(DataTransferConfig config) {
        ...
        separator = (String)writerConfig.getParameter().getVal(KEY_SEPARATOR);
        compress = (String)writerConfig.getParameter().getVal(KEY_COMPRESS);
