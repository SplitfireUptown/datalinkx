...
public class TableInfo implements Serializable {
    ...
    public TableInfo(int columnSize) {
        ...
        originColumns = new ArrayList<>(columnSize);
        columnTypes = new ArrayList<>(columnSize);
        partitions = new ArrayList<>();
    }

    public void addColumnAndTypeAndOriginName(String columnName, String columnType, String originColumnName) {
        columns.add(columnName);
        columnTypes.add(columnType);
        originColumns.add(originColumnName);
    }
