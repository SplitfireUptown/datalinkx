...
public class HiveConnection implements Connection {
    ...
    private String getServerHttpUrl(boolean useSsl) {
        ...
        // JDBC dsdriver will set up an https url if ssl is enabled, otherwise http
    ...
    /**
     * copy loginTimeout from dsdriver manager. Thrift timeout needs to be in millis
     */
...
//    throw new SQLException("Method not supported");
    ...
    public void setCatalog(String catalog) throws SQLException {
        // Per JDBC spec, if the dsdriver does not support catalogs,
    ...
    public void setReadOnly(boolean readOnly) throws SQLException {
        ...
        // Per JDBC spec, the request defines a hint to the dsdriver to enable database optimizations.
