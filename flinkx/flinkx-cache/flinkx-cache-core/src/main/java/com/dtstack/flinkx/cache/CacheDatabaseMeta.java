...
package com.dtstack.flinkx.cache;
 ...
 */
public class CacheDatabaseMeta extends BaseDatabaseMeta {
    ...
    public String getSqlQueryFields(String tableName) {
        return "SELECT TOP 0 /*+FIRST_ROWS*/ * FROM " + tableName;
    }

    @Override
    public String getSqlQueryColumnFields(List<String> column, String table) {
        return "SELECT TOP 0 /*+FIRST_ROWS*/ " + quoteColumns(column) + " FROM " + quoteTable(table);
    }
