 ...
 */
package com.dtstack.flinkx.kafkacustom.writer;

import com.dtstack.flinkx.config.DataTransferConfig;
import com.dtstack.flinkx.kafkacustom.format.KafkacustomOutputFormat;
 ...
 * @author tudou
 */
public class KafkacustomWriter extends KafkaBaseWriter {

    public KafkacustomWriter(DataTransferConfig config) {
        super(config);
    ...
    public DataStreamSink<?> writeData(DataStream<Row> dataSet) {
        KafkacustomOutputFormat format = new KafkacustomOutputFormat();
